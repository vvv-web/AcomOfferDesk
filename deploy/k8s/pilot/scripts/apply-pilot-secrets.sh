...
FQDN="${PILOT_FQDN:-aod-pilot.local}"
...
data:
  ...
  KEYCLOAK_PUBLIC_BASE_URL: "http://${FQDN}/iam"
  KEYCLOAK_ISSUER_URL: "http://${FQDN}/iam/realms/acom-offerdesk"
  WEB_BASE_URL: "http://${FQDN}"
  PUBLIC_BACKEND_BASE_URL: "http://${FQDN}"
  KC_HTTP_RELATIVE_PATH: "/iam"
  KC_HOSTNAME: "http://${FQDN}/iam"
