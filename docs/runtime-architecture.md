...
3. Backend формирует redirect в Keycloak и ставит state-cookie.
...
- [Автопривязка пользователей к Keycloak](keycloak-autolink.md)
- [Внешние login-ссылки](login-links.md)
