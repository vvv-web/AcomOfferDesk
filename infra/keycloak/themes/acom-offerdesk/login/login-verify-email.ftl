    ...
    <#elseif section = "form">
        <div class="aod-status-card">
            ...
            <p class="aod-status-card__text">
              Подтвердите адрес, чтобы завершить вход или регистрацию. Без подтверждения email contractor-профиль не сможет
              корректно пройти дальнейший review flow в AcomOfferDesk.
            </p>
