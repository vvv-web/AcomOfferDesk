...
export const RequestDetailsMainCard = ({
  ...
  const [isResponsibleContactHighlighted, setIsResponsibleContactHighlighted] = useState(false);
    ...
    >
        ...
        <Stack spacing={0.6} sx={{ minHeight: 74, height: '100%', justifyContent: 'space-between' }}>
          <Stack direction="row" spacing={0.5} alignItems="center">
            ...
            {hasResponsibleContact ? (
              <Tooltip title="Показать контакты ответственного" arrow>
                <IconButton
                  size="small"
                  aria-label="Показать контакты ответственного"
                  onMouseEnter={() => setIsResponsibleContactHighlighted(true)}
                  onMouseLeave={() => setIsResponsibleContactHighlighted(false)}
                  onFocus={() => setIsResponsibleContactHighlighted(true)}
                  onBlur={() => setIsResponsibleContactHighlighted(false)}
                  sx={{
                    width: 20,
                    height: 20,
                    p: 0,
      ...
      <RequestDetailsInfoPanel
        value={{
          ...
          onFinalAmountChange,
          responsibleContact,
          responsibleContactHighlighted: isResponsibleContactHighlighted
        }}
      />
